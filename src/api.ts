 ...
 * @export
 */
export const CardsAuthApiAxiosParamCreator = function (
...
export const CardsAuthApiFp = function (configuration?: Configuration) {
  const localVarAxiosParamCreator =
    CardsAuthApiAxiosParamCreator(configuration);
  return {
    /**
     *
     * @param {*} [options] Override http request option.
 ...
 * @export
 */
export const CardsAuthApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance,
) {
 ...
 * @export
 */
export const CardsCRUDApiAxiosParamCreator = function (
  configuration?: Configuration,
) {
  return {
    /**
    ...
    cardControllerCreate: async (
      ...
      const localVarPath = `/card/{type}`.replace(
        `{${"type"}}`,
     ...
     * @throws {RequiredError}
     */
    cardControllerFindChildren: async (
      type: string,
      parentID: string,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
     ...
     * @throws {RequiredError}
     */
    cardControllerUpdateCardAttributes: async (
      type: string,
      id: string,
      ...
      assertParamExists(
        "cardControllerUpdateCardAttributes",
...
export const CardsCRUDApiFp = function (configuration?: Configuration) {
  const localVarAxiosParamCreator =
    CardsCRUDApiAxiosParamCreator(configuration);
  return {
    /**
     *
     * @param {string} type
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.cardControllerCreate(
          type,
          createCardDto,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["CardsCRUDApi.cardControllerCreate"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.cardControllerFindAll(type, options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["CardsCRUDApi.cardControllerFindAll"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
     ...
     * @throws {RequiredError}
     */
    async cardControllerFindChildren(
      type: string,
      parentID: string,
      options?: RawAxiosRequestConfig,
    ): Promise<
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.cardControllerFindChildren(
          type,
          parentID,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["CardsCRUDApi.cardControllerFindChildren"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.cardControllerFindOne(
          type,
          id,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["CardsCRUDApi.cardControllerFindOne"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.cardControllerRemove(type, id, options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["CardsCRUDApi.cardControllerRemove"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.cardControllerUpdate(
          type,
          id,
          updateCardDto,
          options,
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["CardsCRUDApi.cardControllerUpdate"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
     ...
     * @throws {RequiredError}
     */
    async cardControllerUpdateCardAttributes(
      type: string,
      id: string,
      updateCardAttributesDto: UpdateCardAttributesDto,
      options?: RawAxiosRequestConfig,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.cardControllerUpdateCardAttributes(
          type,
          id,
          updateCardAttributesDto,
          options,
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["CardsCRUDApi.cardControllerUpdateCardAttributes"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
 ...
 * @export
 */
export const CardsCRUDApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance,
) {
  ...
  return {
    ...
    cardControllerCreate(
      requestParameters: CardsCRUDApiCardControllerCreateRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<void> {
      return localVarFp
        .cardControllerCreate(
          requestParameters.type,
          requestParameters.createCardDto,
          options,
        )
        .then((request) => request(axios, basePath));
    },
     ...
     * @throws {RequiredError}
     */
    cardControllerFindAll(
      requestParameters: CardsCRUDApiCardControllerFindAllRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<void> {
      return localVarFp
        .cardControllerFindAll(requestParameters.type, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
     ...
     * @throws {RequiredError}
     */
    cardControllerFindChildren(
      requestParameters: CardsCRUDApiCardControllerFindChildrenRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<void> {
      return localVarFp
        .cardControllerFindChildren(
     ...
     * @throws {RequiredError}
     */
    cardControllerFindOne(
      requestParameters: CardsCRUDApiCardControllerFindOneRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<void> {
      return localVarFp
        .cardControllerFindOne(
     ...
     * @throws {RequiredError}
     */
    cardControllerRemove(
      requestParameters: CardsCRUDApiCardControllerRemoveRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<void> {
      return localVarFp
        .cardControllerRemove(
    ...
    cardControllerUpdate(
      requestParameters: CardsCRUDApiCardControllerUpdateRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<void> {
      return localVarFp
        .cardControllerUpdate(
          requestParameters.type,
          requestParameters.id,
          requestParameters.updateCardDto,
          options,
        )
        .then((request) => request(axios, basePath));
    },
     ...
     */
    cardControllerUpdateCardAttributes(
      requestParameters: CardsCRUDApiCardControllerUpdateCardAttributesRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<void> {
      return localVarFp
        .cardControllerUpdateCardAttributes(
          requestParameters.type,
          requestParameters.id,
          requestParameters.updateCardAttributesDto,
          options,
        )
        .then((request) => request(axios, basePath));
    },
...
export class CardsCRUDApi extends BaseAPI {
   ...
   */
  public cardControllerCreate(
    requestParameters: CardsCRUDApiCardControllerCreateRequest,
    options?: RawAxiosRequestConfig,
  ) {
    return CardsCRUDApiFp(this.configuration)
      .cardControllerCreate(
        requestParameters.type,
        requestParameters.createCardDto,
        options,
   ...
   * @memberof CardsCRUDApi
   */
  public cardControllerFindChildren(
    requestParameters: CardsCRUDApiCardControllerFindChildrenRequest,
    options?: RawAxiosRequestConfig,
  ) {
    return CardsCRUDApiFp(this.configuration)
   ...
   * @memberof CardsCRUDApi
   */
  public cardControllerUpdateCardAttributes(
    requestParameters: CardsCRUDApiCardControllerUpdateCardAttributesRequest,
    options?: RawAxiosRequestConfig,
  ) {
    return CardsCRUDApiFp(this.configuration)
